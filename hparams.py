...
### kss ###
dataset = "data"
data_path = os.path.join("/mnt/dms/prac/handong", dataset)
...
# checkpoint_path = '/mnt/dms/prac/weights/'
# eval_path = os.path.join("./eval/", dataset)
# log_path = os.path.join("./log/", dataset)
# test_path = "./results"
preprocessed_path = "/mnt/dms/prac/handong/data/prepro/"
# checkpoint_path = '/mnt/dms/prac/weights'
checkpoint_path = '/mnt/dms/prac/handong/output/'
eval_path = os.path.join("./eval/", dataset)
log_path = os.path.join("./log/", dataset)
test_path = "./results"
...
# # Vocoder
vocoder = 'vocgan'
vocoder_pretrained_model_name = "kss_vocgan2_4620.pt"
